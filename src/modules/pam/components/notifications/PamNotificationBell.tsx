    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="relative text-inherit hover:bg-black/5 focus-visible:ring-2 focus-visible:ring-white/40"
        >
          <Bell className="h-5 w-5" />
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center rounded-full bg-white text-red-600 text-xs font-bold shadow-sm ring-1 ring-white/70">
