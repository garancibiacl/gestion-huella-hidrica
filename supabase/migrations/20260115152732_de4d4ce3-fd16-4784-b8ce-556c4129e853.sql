...
CREATE INDEX IF NOT EXISTS idx_hazard_hierarchy_org ON hazard_catalog_hierarchy(organization_id);
CREATE INDEX IF NOT EXISTS idx_hazard_hierarchy_stable ON hazard_catalog_hierarchy(stable_id);
CREATE INDEX IF NOT EXISTS idx_hazard_hierarchy_gerencia ON hazard_catalog_hierarchy(organization_id, gerencia);
...
CREATE INDEX IF NOT EXISTS idx_hazard_risks_org ON hazard_critical_risks(organization_id);
CREATE INDEX IF NOT EXISTS idx_hazard_risks_severity ON hazard_critical_risks(severity);
...
CREATE INDEX IF NOT EXISTS idx_hazard_responsibles_org ON hazard_responsibles(organization_id);
CREATE INDEX IF NOT EXISTS idx_hazard_responsibles_email ON hazard_responsibles(email);
...
CREATE INDEX IF NOT EXISTS idx_hazard_control_types_org ON hazard_control_types(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_hazard_reports_org ON hazard_reports(organization_id);
CREATE INDEX IF NOT EXISTS idx_hazard_reports_status ON hazard_reports(organization_id, status);
CREATE INDEX IF NOT EXISTS idx_hazard_reports_closing_responsible ON hazard_reports(closing_responsible_id);
CREATE INDEX IF NOT EXISTS idx_hazard_reports_reporter ON hazard_reports(reporter_user_id);
CREATE INDEX IF NOT EXISTS idx_hazard_reports_due_date ON hazard_reports(organization_id, due_date);
CREATE INDEX IF NOT EXISTS idx_hazard_reports_critical_risk ON hazard_reports(critical_risk_id);
CREATE INDEX IF NOT EXISTS idx_hazard_reports_created_at ON hazard_reports(organization_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_hazard_evidences_report ON hazard_report_evidences(hazard_report_id);
CREATE INDEX IF NOT EXISTS idx_hazard_evidences_type ON hazard_report_evidences(hazard_report_id, evidence_type);
...
CREATE INDEX IF NOT EXISTS idx_hazard_events_report ON hazard_report_events(hazard_report_id, created_at DESC);
...
DROP TRIGGER IF EXISTS hazard_report_created ON hazard_reports;
...
DROP TRIGGER IF EXISTS hazard_report_closed ON hazard_reports;
...
DROP TRIGGER IF EXISTS update_hazard_report_updated_at ON hazard_reports;
